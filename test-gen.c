...
{
  const char *regexes[] = {
      "[\320\247-V\027-k\353\260\230-\037\340\277\271-:\352\213\221-"
      "\344\255\227\350\214\270-~\\--\343\216\210U-\320\2461-\351\251\217]",
  };
  size_t regexes_n[] = {
      46,
  };
  PROPAGATE(check_matches_n(
      regexes, regexes_n, 1, "\351\262\240", 3, 0, 0, 'B', NULL, NULL, 1));
  PASS();
}
