...
/*T Generated by `unicode_data.py gen_ccs test` */
...
{
  static const re_u32 ranges[] = {0x41, 0x5A, 0x61, 0x7A};
...
{
  static const re_u32 ranges[] = {0x0, 0x7F};
...
{
  static const re_u32 ranges[] = {0x9, 0x9, 0x20, 0x20};
...
{
  static const re_u32 ranges[] = {0x0, 0x1F, 0x7F, 0x7F};
...
{
  static const re_u32 ranges[] = {0x30, 0x39};
...
{
  static const re_u32 ranges[] = {0x21, 0x7E};
...
{
  static const re_u32 ranges[] = {0x61, 0x7A};
...
{
  static const re_u32 ranges[] = {0x9, 0xA, 0xC, 0xD, 0x20, 0x20};
...
{
  static const re_u32 ranges[] = {0x20, 0x7E};
...
{
  static const re_u32 ranges[] = {0x21, 0x2F, 0x3A, 0x40,
                                  0x5B, 0x60, 0x7B, 0x7E};
...
{
  static const re_u32 ranges[] = {0x9, 0xD, 0x20, 0x20};
...
{
  static const re_u32 ranges[] = {0x41, 0x5A};
...
{
  static const re_u32 ranges[] = {0x30, 0x39, 0x41, 0x46, 0x61, 0x66};
...
{
  static const re_u32 ranges[] = {0x0, 0x1F, 0x7F, 0x9F};
...
{
  static const re_u32 ranges[] = {0xE000,   0xE000,   0xF8FF,   0xF8FF,
...
{
  static const re_u32 ranges[] = {0xD800, 0xD800, 0xDB7F, 0xDB80,
...
{
  static const re_u32 ranges[] = {0x1C5,  0x1C5,  0x1C8,  0x1C8,  0x1CB,
...
{
  static const re_u32 ranges[] = {0x488,  0x489,  0x1ABE, 0x1ABE, 0x20DD,
...
{
  static const re_u32 ranges[] = {0x5F,   0x5F,   0x203F, 0x2040,
...
{
  static const re_u32 ranges[] = {0xBB,   0xBB,   0x2019, 0x2019, 0x201D,
...
{
  static const re_u32 ranges[] = {0x2028, 0x2028};
...
{
  static const re_u32 ranges[] = {0x2029, 0x2029};
...
{
  static const re_u32 ranges[] = {0x20,   0x20,   0xA0,   0xA0,   0x1680,
...
/*T Generated by `unicode_data.py gen_fuzz_regression_tests` */
...
{
  const char *regexes[] = {
      "\\5r\\z@\x00+\x01\x00\x00\x01+.+++]\xCB\x80.\x00\x00+][^]\x04?w\\?\\w?"
      "w\\?\\wwwwww?\\w\x00\x00\x00\x00\x04?w\\?\\w?w\\?\\wwwwww?\\w=?\\w?w\\?"
      "\\w\x0Ewww?\\w\x00ww+\\?\\?\\ww?wwww?w\\?\\w?w\\?\\ww=?\\w?w\\?\\ww\\?"
      "\\ww?\x01\x00\x00\x00\x00\x00\x00\x04?w\\?\\w?w\\?\\wwwwww?"
      "\\w\x00\x00\x00\x00\x04?w\\?\\w?w\\?\\w\\?\\w\x0Ewww?\\w\x00ww+\\?\\?"
      "\\ww?wwww?w\\?\\w?w\\?\\ww=?\\w?w\\?\\w\x0Ew\x0Ewwwwww?\\w=?\\w?w\\?"
      "\\w\x0EZ\x00\x00\x00www?\\w\x00ww+\\?\\?\\ww?wwww?w\\?\\w?w\\?\\ww=?\\w?"
      "w\\?\\w\x0Ew\x0Ewww?\\www+\\?+*++++++++??++++++\\ww+.?++*++++++++++D\\D]"
      "++*++*++??++++++*+++++M\x00+\"+]++*+++",
  };
  const char *text = "\xC2\xA0";
  size_t regexes_n[] = {
