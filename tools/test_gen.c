...
mptest__result assert_cc_match_raw(
    const char *regex, const bbre_u32 *ranges, bbre_u32 nrange, int invert);
int check_noparse_n(
...
{
  static const bbre_u32 ranges[] = {0x30, 0x39, 0x41, 0x5A, 0x61, 0x7A};
...
{
  static const bbre_u32 ranges[] = {0x41, 0x5A, 0x61, 0x7A};
...
{
  static const bbre_u32 ranges[] = {0x0, 0x7F};
...
{
  static const bbre_u32 ranges[] = {0x9, 0x9, 0x20, 0x20};
...
{
  static const bbre_u32 ranges[] = {0x0, 0x1F, 0x7F, 0x7F};
...
{
  static const bbre_u32 ranges[] = {0x30, 0x39};
...
{
  static const bbre_u32 ranges[] = {0x21, 0x7E};
...
{
  static const bbre_u32 ranges[] = {0x61, 0x7A};
...
{
  static const bbre_u32 ranges[] = {0x9, 0xA, 0xC, 0xD, 0x20, 0x20};
...
{
  static const bbre_u32 ranges[] = {0x20, 0x7E};
...
{
  static const bbre_u32 ranges[] = {0x21, 0x2F, 0x3A, 0x40,
                                    0x5B, 0x60, 0x7B, 0x7E};
...
{
  static const bbre_u32 ranges[] = {0x9, 0xD, 0x20, 0x20};
...
{
  static const bbre_u32 ranges[] = {0x41, 0x5A};
...
{
  static const bbre_u32 ranges[] = {0x30, 0x39, 0x41, 0x5A,
                                    0x5F, 0x5F, 0x61, 0x7A};
...
{
  static const bbre_u32 ranges[] = {0x30, 0x39, 0x41, 0x46, 0x61, 0x66};
...
{
  static const bbre_u32 ranges[] = {0x0, 0x1F, 0x7F, 0x9F};
...
{
  static const bbre_u32 ranges[] = {0xE000,   0xE000,   0xF8FF,   0xF8FF,
...
{
  static const bbre_u32 ranges[] = {0xD800, 0xD800, 0xDB7F, 0xDB80,
...
{
  static const bbre_u32 ranges[] = {0x1C5,  0x1C5,  0x1C8,  0x1C8,  0x1CB,
...
{
  static const bbre_u32 ranges[] = {0x488,  0x489,  0x1ABE, 0x1ABE, 0x20DD,
...
{
  static const bbre_u32 ranges[] = {0x5F,   0x5F,   0x203F, 0x2040,
...
{
  static const bbre_u32 ranges[] = {0xBB,   0xBB,   0x2019, 0x2019, 0x201D,
...
{
  static const bbre_u32 ranges[] = {0x2028, 0x2028};
...
{
  static const bbre_u32 ranges[] = {0x2029, 0x2029};
...
{
  static const bbre_u32 ranges[] = {0x20,   0x20,   0xA0,   0xA0,   0x1680,
...
TEST(fuzz_regression_0001)
{
  ...
  const char *text = "+";
  size_t regex_n = 15;
  PROPAGATE(check_matches_n(regex, regex_n, (const char *)text, 1, 0, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0003)
{
  ...
  size_t regex_n = 46;
  PROPAGATE(check_matches_n(regex, regex_n, (const char *)text, 3, 0, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0004)
{
  ...
  size_t regex_n = 8;
  PROPAGATE(
      check_matches_n(regex, regex_n, (const char *)text, 16, 0, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0005)
{
  ...
  size_t regex_n = 37;
  PROPAGATE(check_matches_n(regex, regex_n, (const char *)text, 4, 0, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0007)
{
  ...
  size_t regex_n = 61;
  PROPAGATE(
      check_matches_n(regex, regex_n, (const char *)text, 2721, 0, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0008)
{
  ...
  size_t regex_n = 23;
  PROPAGATE(
      check_matches_n(regex, regex_n, (const char *)text, 17, 0, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0009)
{
  ...
  size_t regex_n = 100;
  PROPAGATE(
      check_matches_n(regex, regex_n, (const char *)text, 14, 0, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0012)
{
  ...
  size_t regex_n = 2;
  PROPAGATE(check_matches_n(regex, regex_n, (const char *)text, 2, 0, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0013)
{
  PROPAGATE(check_noparse_n(
      "-[Z\x00`-", 6,
      "expected ending character after '-' for character class range "
      "expression",
      6));
  PASS();
}
...
TEST(fuzz_regression_0014)
{
  ...
  const char *text = "";
  size_t regex_n = 22;
  PROPAGATE(check_matches_n(regex, regex_n, (const char *)text, 0, 0, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0016)
{
  ...
  size_t regex_n = 20;
  PROPAGATE(
      check_matches_n(regex, regex_n, (const char *)text, 10, 0, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0017)
{
  ...
  size_t regex_n = 78;
  PROPAGATE(check_matches_n(regex, regex_n, (const char *)text, 9, 0, NULL, 1));
  PASS();
}
