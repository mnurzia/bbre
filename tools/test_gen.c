...
TEST(fuzz_regression_0001)
{
  ...
  PROPAGATE(check_matches_n(
      regexes, regexes_n, 1, (const char *)text, 1, 0, 0, NULL, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0003)
{
  ...
  PROPAGATE(check_matches_n(
      regexes, regexes_n, 1, (const char *)text, 3, 0, 0, NULL, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0004)
{
  ...
  PROPAGATE(check_matches_n(
      regexes, regexes_n, 1, (const char *)text, 16, 0, 0, NULL, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0005)
{
  ...
  PROPAGATE(check_matches_n(
      regexes, regexes_n, 1, (const char *)text, 4, 0, 0, NULL, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0007)
{
  ...
  PROPAGATE(check_matches_n(
      regexes, regexes_n, 1, (const char *)text, 2721, 0, 0, NULL, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0008)
{
  ...
  PROPAGATE(check_matches_n(
      regexes, regexes_n, 1, (const char *)text, 17, 0, 0, NULL, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0009)
{
  ...
  PROPAGATE(check_matches_n(
      regexes, regexes_n, 1, (const char *)text, 14, 0, 0, NULL, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0012)
{
  ...
  PROPAGATE(check_matches_n(
      regexes, regexes_n, 1, (const char *)text, 2, 0, 0, NULL, NULL, 1));
  PASS();
}
...
TEST(fuzz_regression_0014)
{
  ...
  PROPAGATE(check_matches_n(
      regexes, regexes_n, 1, (const char *)text, 0, 0, 0, NULL, NULL, 1));
  PASS();
}
