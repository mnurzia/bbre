...
TEST(fuzz_regression_0018)
{
  ...
  PROPAGATE(
      check_matches_n(regex, regex_n, (const char *)text, 2, 1, spans, 1));
  PASS();
}
...
TEST(fuzz_regression_0019)
{
  ...
  PROPAGATE(
      check_matches_n(regex, regex_n, (const char *)text, 2, 2, spans, 1));
  PASS();
}
...
TEST(fuzz_regression_0020)
{
  ...
  PROPAGATE(
      check_matches_n(regex, regex_n, (const char *)text, 4, 3, spans, 1));
  PASS();
}
